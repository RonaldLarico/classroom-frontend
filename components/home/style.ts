...
export const SidebarButton = styled.button<SSidebarProps>`
    ${btnReset};
    position: absolute;
    top: ${v.xxlSpacing};
...
export const LinkContainer = styled.div<SLinkContainerProps>`
...
export const ThemeLabel = styled.span`
    ...
    flex: 1;
`;
export const ThemeToggler = styled.button<SLinkContainerProps>`
    ${btnReset};
    margin: 0 auto;
    cursor: pointer;
    width: 36px;
