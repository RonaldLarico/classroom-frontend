const Modal: React.FC<{
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className={`bg-secondary-color rounded-2xl shadow md:p-5 p-2 transition-all max-w-[480px] sm:w-full w-full max-h-screen ${modalClass} flex flex-col items-center overflow-auto`}
